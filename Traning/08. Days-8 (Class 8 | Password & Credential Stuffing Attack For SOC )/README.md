...
---
 ...
 #  | Preview                              | Description                              |
|----|--------------------------------------|------------------------------------------|
| 1  | ![Screenshot 1](./Daus-8-image/1.png)   | TYPES OF PASSWORD ATTACKS
| 2  | ![Screenshot 1](./Daus-8-image/2.png)   | TYPES OF PASSWORD ATTACKS |
| 3  | ![Screenshot 1](./Daus-8-image/3.png)   | TYPES OF BRUTE FORCE ATTACKS |
